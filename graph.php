  ...
  <strong>
    <font color="white" size="4">
      <div align="center">
        ...
        <span class="abc" style="background-color:#000000">日降水量：<?php echo $rain_today_now . "ml"; ?></span><br><br>
        <span class="abc" style="background-color:#000000">積算降水量：<?php echo $rain_total_now . "ml"; ?></span>
