  ...
  <script type="text/javascript">
    ...
    function image_merge() {
      ...
      $.ajax({
        ...
        //通信成功時
        .done(function(data) {
          f_name = '/var/www/html/ks-foods/images/dl/' + s_date + "_" + s_time + "00-" + e_date + "_" + e_time + "00_cam" + <?php echo $camera_id ?> + ".mp4";
    ...
    <form method='POST' action='main_dev.php'>
      <table>
        <td>
          ...
          <input type="hidden" name="time" value="<?php echo $selTime ?>">
